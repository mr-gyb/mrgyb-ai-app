...
import { ChevronLeft, Star, Bot, Briefcase, Grid, Map as MapIcon, Newspaper, Search, Users, Compass } from 'lucide-react';
...
type FeedTab = 'groups' | 'explore' | 'search';
    ...
    channel
      .on('postgres_changes', 
        ...
        async () => {
          ...
          setFilteredUsers(updatedProfiles);
        }
      )
      .subscribe();
